...
struct EWMAPrediction : Node {
  double decay_;
  std::unordered_map<std::tuple<ParamId, u32>, EWMA, KeyHash, KeyEqual> swind_;
...
struct SMAPrediction : Node {
  size_t width_;
  std::unordered_map<std::tuple<ParamId, u32>, SMA, KeyHash, KeyEqual> swind_;
  std::shared_ptr<Node> next_;
  const bool delta_;
...
struct CMAPrediction : Node {
  std::unordered_map<std::tuple<ParamId, u32>, std::pair<double, size_t>, KeyHash, KeyEqual> swind_;
  std::shared_ptr<Node> next_;
