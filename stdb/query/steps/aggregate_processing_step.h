 ...
 */
#ifndef STDB_QUERY_STEPS_AGGREGATE_PROCESSING_STEP_H_
#define STDB_QUERY_STEPS_AGGREGATE_PROCESSING_STEP_H_
...
#endif  // STDB_QUERY_STEPS_AGGREGATE_PROCESSING_STEP_H_
